...
public class SendMockLocationService extends Service implements
    ...
    private void postNotification(String contentText) {
        ...
        Log.d("WHATS HAPPENING","Pre POSTING Notification");
        ...
        String contentTitle = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"; //this.getString(R.string.notification_title_test_start);
    ...
    public int onStartCommand(Intent startIntent, int flags, int startId) {
        ...
        if (
            ...
            Log.d("WHATS HAPPENING","POSTING Notification");
            ...
            Log.d("WHATS HAPPENING","POSTING Notification Done");
